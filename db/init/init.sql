...
CREATE TABLE IF NOT EXISTS user_roles (
                                          user_id    INTEGER NOT NULL CONSTRAINT user_roles_user_fk REFERENCES users(id) ON DELETE CASCADE,
    role_id    INTEGER NOT NULL CONSTRAINT user_roles_role_fk REFERENCES roles(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS carts (
                                     ...
                                     user_id      INTEGER NOT NULL UNIQUE CONSTRAINT carts_user_fk REFERENCES users(id) ON DELETE CASCADE,
    created_at   TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at   TIMESTAMPTZ NOT NULL DEFAULT NOW()
    );
...
CREATE TABLE IF NOT EXISTS cart_items (
                                          ...
                                          cart_id      INTEGER NOT NULL CONSTRAINT cart_items_cart_fk REFERENCES carts(id) ON DELETE CASCADE,
    product_id   INTEGER NOT NULL CONSTRAINT cart_items_product_fk REFERENCES products(id),
...
CREATE TABLE IF NOT EXISTS purchases (
                                         ...
                                         user_id      INTEGER NOT NULL CONSTRAINT purchases_user_fk REFERENCES users(id) ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS purchase_items (
                                              ...
                                              purchase_id  INTEGER NOT NULL CONSTRAINT purchase_items_purchase_fk REFERENCES purchases(id) ON DELETE CASCADE,
    product_id   INTEGER NOT NULL CONSTRAINT purchase_items_product_fk REFERENCES products(id),
    quantity     INTEGER NOT NULL CHECK (quantity > 0),
